...
return [
    ...
    'ws' => [
        ...
        'ssl' => false,
        'events' => [
            ['open', \App\Core\Events::class, 'onOpen'],
            ['message', \App\Core\Events::class, 'onMessage'],
            ['close', \App\Core\Events::class, 'onClose'],
            ['request', \App\Core\Events::class, 'onRequest'],
            ['Task', \App\Core\Events::class, 'onTask'],
            ['Finish', \App\Core\Events::class, 'onFinish'],
            ['workerStart', \App\Core\Events::class, 'onWorkerStart'],
            ['start', \App\Core\Events::class, 'onStart'],
        ],
        'settings' => [
